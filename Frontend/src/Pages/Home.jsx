    ...
    const fetchLatestProperties = async () => {
      try {
        ...
        if (response.status === 200) {
          console.log(
            "All statuses:",
            response.data.properties.map((p) => p.status)
          );
          ...
          setLatestProperties(filteredProperties.slice(0, 6));
        }
      } catch (error) {
    ...
    <div className="w-full font-sans">
      <div className="relative h-[85vh] flex flex-col md:flex-row items-center justify-center px-10 bg-gray-100 text-black text-left gap-1">
        ...
        <div className="relative z-10 max-w-xl mt-32 md:mt-0">
          <h1 className="text-4xl md:text-6xl font-bold tracking-wide capitalize">
            Find Your Dream Home
          </h1>
          <p className="text-2xl text-gray-700 mt-4 leading-relaxed">
            Explore our exclusive listings and discover the perfect property for
            you and your family.
          </p>
          <NavLink
            to="/listing"
        ...
        <div className="relative z-10 flex justify-center">
          <img
            src={assets.home_img}
            alt="Home"
            className="w-full max-w-xl md:max-w-2xl rounded-2xl"
          />
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-lg mb-6 leading-relaxed">
              At Dream Estate's, we are committed to helping you find the
              perfect place to call home. With years of experience in the real
              estate industry, we offer personalized services tailored to meet
              your needs. Whether you are looking to buy or rent, our team is
      ...
      <div className="flex justify-between items-center max-w-6xl mx-auto mb-4">
        ...
        <NavLink
          to="/listing"
          className="bg-green-500 text-white px-4 py-2 rounded-md font-medium text-sm hover:bg-green-600 transition"
        >
          View More
        </NavLink>
      </div>
      <Swiper
        ...
        className="max-w-6xl mx-auto latest-properties-swiper"
      >
        {latestProperties.map((property, index) => (
          <SwiperSlide key={index}>
            <div className="bg-white shadow-lg rounded-lg overflow-hidden transition pb-5 transform hover:scale-105 hover:shadow-xl">
              <img
                src={
                  property.images?.[0]
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-gray-100 p-8 rounded-lg shadow hover:shadow-md transition flex flex-col items-center text-center"
              >
                <img
                  src={service.img}
                  alt={service.title}
            ...
            {[
              {
                ...
                name: "John Doe",
                feedback:
                  "Dream Estates helped me find the perfect home. Highly recommend!",
              },
              {
                img: assets.profile_img_2,
                name: "Joel Smith",
                feedback:
                  "Smooth experience from start to finish. Very professional team!",
              },
              {
                img: assets.profile_img_3,
                name: "Mike Johnson",
                feedback:
                  "Great listings and amazing service. Thank you Dream Estates!",
              },
